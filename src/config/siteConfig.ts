...
export const siteConfig: SiteConfig = {
	title: "Xwei2051 Signal Archive",
	subtitle: "收集问题、工具和生活里的微弱信号",
	siteURL: "https://xwei2051.github.io/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-07-20", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	navbarTitle: {
		...
		icon: "/assets/brand/xwei-navbar-avatar.png",
		// 网站Logo图片路径
	...
	// 壁纸模式配置
	wallpaperMode: {
		// 默认壁纸模式：banner=顶部横幅，fullscreen=全屏壁纸，none=无壁纸，overlay=覆盖模式
	...
	banner: {
		...
		src: {
			desktop: "/assets/wallpaper/xwei-rain-desktop.webp", // 桌面横幅图片
			mobile: "/assets/wallpaper/xwei-rain-mobile.webp", // 移动横幅图片
		}, // 使用本地横幅图片
